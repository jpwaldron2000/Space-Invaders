...
class Alien(Sprite):
    ...
    alien_explosion_images = [pg.transform.rotozoom(pg.image.load(f'images/alien_explosion_0{n}.png'), 0, 3.0) for n in range(11)]

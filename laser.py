...
class Laser(Sprite):
    ...
    alien_laser_images = [pg.transform.rotozoom(pg.image.load(f'images/alien_laser{n}.png'), 0, 5) for n in range(2)]
    ship_laser_images = [pg.transform.rotozoom(pg.image.load(f'images/laser_{n}.png'), 0, 5) for n in range(2)]
